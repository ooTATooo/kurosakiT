...
struct KdAmbientParameter
{
	...
	float m_coneLightAngle;
	float m_conrLightRange;
...
public:
	...
	// コーンライトの設定
	void SetConeLight(const Math::Vector3& _pos, const Math::Vector3& _dir, const float _angle, const float _range, const Math::Vector3& _color);
